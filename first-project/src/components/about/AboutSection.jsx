...
const AboutSection = ({ children }) => {
  ...
  return (
    <section className="origin-top-left relative">
      ...
      >
        {children}
        <div className="h-screen flex pt-16 px-28" style={bg}>
          ...
          <div className="div2 relative bg-stone-300 w-2/4 flex justify-center items-center float-left">
            <div className="w-4/5 h-5/6 bg-stone-300 relative z-10 flex flex-col justify-center">
              ...
              <p className="text-black text-md mb-9 capitalize tracking-wide text-justify">
                ...
                neque accusantium! Vitae ipsa placeat accusamus, mollitia aut
                enim perferendis, veritatis natus iste delectus laudantium
                dolorem at quam quas nemo quaerat vel. Praesentium delectus
                dolorum vel vitae, odio animi autem consequuntur maxime odit at
          ...
          <div
            className="absolute bottom-0 left-0 w-full h-60 bg-red-700"
            style={{
