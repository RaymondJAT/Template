...
const ContactPage = () => {
  const background = {
    backgroundImage: `linear-gradient(to bottom, rgba(229, 231, 240, 0.5), rgba(90, 101, 111, 0.1))`,
  };
      ...
      <div className="container w-full flex flex-col md:flex-row justify-between items-center ml-32 mt-8">
        <div className="contactInfo w-full md:w-6/12 flex flex-col md:mr-8">
          <div className="box relative py-10 px-0 flex">
            ...
            <div className="text flex ml-12 text-base text-red-700 flex-col font-semibold">
              <h3>Address</h3>
