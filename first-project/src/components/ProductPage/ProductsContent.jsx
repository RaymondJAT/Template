    ...
    <div className="service-container min-h-screen w-full bg-slate-100">
      <div className="service-wrapper py-[5%] px-[8%]">
        <div className="service flex flex-col items-center">
          <div className="service-cards grid grid-cols-4 gap-24">
            ...
            <div className="card h-[480px] -mt-20 w-80 py-[3%] px-[8%] flex items-center flex-col relative overflow-hidden border-4 border-red-600 rounded-xl">
              <img
                src={ups}
                alt=""
                className="mt-8 mb-5 h-52 w-full rounded-xl"
